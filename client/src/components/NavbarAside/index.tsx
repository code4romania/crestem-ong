...
const NavbarAside = () => (
  <aside className="bg-gray-100">
    <div className="container mx-auto flex py-3 px-2.5">
      <a
        href="https://www.commitglobal.org"
        target="_blank"
        rel="noopener"
        className="flex items-center w-full max-w-2xl gap-3 text-sm hover:text-blue-600 focus:text-blue-600 focus:outline-0 hover:underline focus:underline"
      >
        <svg
